  ...
  <div class="about-section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="item_s">
            <img src="/img/s_1.png" class="svg_item_image" alt="#">
            <p>Высокое качество<br>продукции по<br>доступным ценам</p>  
          </div>
        </div>
        <div class="col-md-3">
          <div class="item_s">
            <img src="/img/s_2.png" class="svg_item_image" alt="#">
            <p>Штат опытных<br>сотрудников</p>
          </div>
        </div>
        <div class="col-md-3">
          <div class="item_s">
            <img src="/img/s_3.png" class="svg_item_image" alt="#">
            <p>Trade-in: принимаем<br>Вашу технику в зачет</p>
          </div>
        </div>
        <div class="col-md-3">
          <div class="item_s">
            <img src="/img/s_4.png" class="svg_item_image" alt="#">
